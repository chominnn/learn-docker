...
import { GitBranch, Workflow, Rocket, Code } from 'lucide-react';
...
export function CicdHeroSection() {
  ...
  const scrollToContent = () => {
    const firstSection = document.getElementById('cicd-layer-0');
    if (firstSection) {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      {/* Floating icons */}
      <FloatingIcon Icon={GitBranch} className="top-[15%] left-[10%]" delay={0} />
      <FloatingIcon Icon={Workflow} className="top-[20%] right-[15%]" delay={400} />
      <FloatingIcon Icon={Rocket} className="bottom-[30%] left-[8%]" delay={800} />
      <FloatingIcon Icon={Code} className="bottom-[25%] right-[12%]" delay={1200} />
      ...
      <div className="text-center relative z-10 max-w-4xl mx-auto">
        ...
        >
          코드 커밋부터 프로덕션 배포까지 자동화하세요. GitHub Actions, GitLab CI, Jenkins를 마스터하세요.
        </p>
        ...
        <div ref={buttonRef} className="opacity-0 mb-16 cursor-pointer">
          ...
          >
            ...
            <div className="text-left">
              <div className="text-primary font-mono text-sm mb-1">git push origin main</div>
