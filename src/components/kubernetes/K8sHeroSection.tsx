...
import { Box, Layers, Network, Server } from 'lucide-react';
...
export function K8sHeroSection() {
  ...
  const scrollToContent = () => {
    const firstSection = document.getElementById('k8s-layer-0');
    if (firstSection) {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="text-center relative z-10 max-w-4xl mx-auto">
        ...
        >
          컨테이너 오케스트레이션을 마스터하세요. Pods, Services, Deployments부터 고급 개념까지.
        </p>
        ...
        <div ref={buttonRef} className="opacity-0 mb-16 cursor-pointer">
          ...
          >
            ...
            <div className="text-left">
              <div className="text-secondary font-mono text-sm mb-1">kubectl get pods</div>
