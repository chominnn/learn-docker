...
export function LoggingHeroSection() {
  ...
  const scrollToContent = () => {
    const firstSection = document.getElementById('logging-layer-0');
    if (firstSection) {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      {/* Floating icons */}
      <FloatingIcon Icon={FileText} className="top-[15%] left-[10%]" delay={0} />
      <FloatingIcon Icon={Search} className="top-[20%] right-[15%]" delay={400} />
      <FloatingIcon Icon={Database} className="bottom-[30%] left-[8%]" delay={800} />
      <FloatingIcon Icon={Filter} className="bottom-[25%] right-[12%]" delay={1200} />
      ...
      <div className="text-center relative z-10 max-w-4xl mx-auto">
        ...
        <h1
          ref={titleRef}
          className="text-5xl md:text-7xl lg:text-8xl font-bold text-secondary tracking-tight mb-4"
        ...
        >
          애플리케이션 로그를 수집하고 분석하세요.
          <br />
          ELK Stack, Loki로 로그 검색과 분석을 마스터하세요.
        </p>
        ...
        <div ref={buttonRef} className="opacity-0 mb-16 cursor-pointer">
          ...
          >
            ...
            <div className="text-left">
              <div className="text-secondary font-mono text-sm mb-1">elasticsearch --version</div>
