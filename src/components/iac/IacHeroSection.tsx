...
import { Cloud, Code, Server, Layers } from 'lucide-react';
...
export function IacHeroSection() {
  ...
  const scrollToContent = () => {
    const firstSection = document.getElementById('iac-layer-0');
    if (firstSection) {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      {/* Floating icons */}
      <FloatingIcon Icon={Cloud} className="top-[15%] left-[10%]" delay={0} />
      <FloatingIcon Icon={Code} className="top-[20%] right-[15%]" delay={400} />
      <FloatingIcon Icon={Server} className="bottom-[30%] left-[8%]" delay={800} />
      <FloatingIcon Icon={Layers} className="bottom-[25%] right-[12%]" delay={1200} />
      ...
      <div className="text-center relative z-10 max-w-4xl mx-auto">
        ...
        <h1
          ref={titleRef}
          className="text-4xl md:text-6xl lg:text-7xl font-bold text-secondary tracking-tight mb-4 whitespace-nowrap"
        ...
        >
          코드로 인프라를 관리하세요. Terraform으로 서버, 네트워크, 스토리지를 자동화하세요.
        </p>
        ...
        <div ref={buttonRef} className="opacity-0 mb-16 cursor-pointer">
          <div 
            ...
            className="inline-flex items-center gap-4 bg-surface/50 backdrop-blur-sm border border-secondary/30 rounded-2xl px-8 py-6 hover:border-secondary/60 transition-colors group"
          >
            <div className="relative">
              <div className="w-16 h-16 bg-secondary/20 rounded-xl flex items-center justify-center group-hover:bg-secondary/30 transition-colors font-mono text-secondary text-2xl">
                $&gt;
              </div>
            ...
            <div className="text-left">
              <div className="text-secondary font-mono text-sm mb-1">terraform apply</div>
      ...
      <div
        ...
        onClick={scrollToContent}
      >
        <div className="flex flex-col items-center gap-3 text-muted hover:text-secondary transition-colors">
