...
import {
  ...
  MonitoringLayer0Problem,
  MonitoringLayer1Metrics,
  MonitoringLayer2Prometheus,
  MonitoringLayer3Grafana,
  MonitoringLayer4Alerting,
  MonitoringLayer5Logging,
  MonitoringLayer6Tracing,
  MonitoringLayer7BestPractices,
    ...
    <main className="relative overflow-x-hidden">
      ...
      <footer className="py-8 px-4 border-t border-muted/20">
        <div className="max-w-4xl mx-auto text-center text-sm text-muted font-mono space-y-2">
          <div>Monitoring Made Easy — Learn Observability</div>
          <div>
            Built by{' '}
            <a
